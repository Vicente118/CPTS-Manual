...
---
#### Checking for Existing Trusts using Get-DomainTrust with PowerView (Better)
```powershell
...
========= =======================           ==========
<->       LOGISTICS.INLANEFREIGHT.LOCAL       Direct     Not found

<->       FREIGHTLOGISTICS.LOCAL              Direct     Not found
```
