List of unencrypted protocol and their corresponding encrypted counterpart.
...
#### Find Specific Strings in Packets
You can navigate to `Edit > Find Packet` and enter the desired search query manually. For example, you might search for packets containing the string `"passw".

---
## Pcredz
[Pcredz](https://github.com/lgandx/PCredz) is a tool that can be used to extract credentials from live traffic or network packet captures.
```shell
